...
if (badBlockStart !== -1 && badBlockEnd > badBlockStart) {
  ...
  console.log("Could not find the block bounds. Start:", badBlockStart, "End:", badBlockEnd);
}
